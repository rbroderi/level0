...
FORMATS = {
    "Armenian": (("personal", "family"),),
    "Chinese": (("family", "personal"),),
    "Danish": (("personal", "family"), ("personal", "personal", "family")),
    "English": (("personal", "personal", "family"), ("personal", "family")),
    "Finnish": (("personal", "family"), ("personal", "personal", "family")),
    "French": (("personal", "family"), ("personal", "personal", "family")),
    ...
    "Latin": (("personal", "family"), ("personal", "family", "additional")),
    "Latvian": (("personal", "family"),),
    "Old Spanish": (
        ("personal", "patronym"),
        ("personal", "patronym", "family"),
    ),
    "Polish": (("personal", "personal", "family"), ("personal", "family")),
    "Russian": (("personal", "patronym", "family"),),
    "Spanish": (
        ("personal", "patriname", "matriname"),
    ...
    "Fantasy": (("personal", "personal", "family"), ("personal", "family")),
}
...
def generate(nationality=None, gender=None, verbosity=0):
    ...
    nationality = (
        nat_lookup(nationality)
        if nationality is not None
        else random.choice(NATIONALITIES)
    )
    ...
    for part in fmt:
        ...
        random_choices = getdata(
            source,
            gender=gender,
            nationality=nationality,
            not_name=seen_names[part],
            randomise=True,
            limit=1,
            verbosity=verbosity,
        )
